...
你可以在 [in the build configuration](/docs/manual/latest/build-configuration#warnings) 或
[using the `@@warning()` decorator](/syntax-lookup#module-warning-decorator) 配置 ReScript 编译器生成哪些警告。
