...
function make(props) {
          ...
          switch (match) {
            ...
            case "docs-cn" :
                ...
                if (match$7 === "manual") {
                  ...
                  var match$8 = Belt_Array.get(pagepath$1, 0);
                  var exit$4 = 0;
                  if (match$8 === "api") {
                    if (version$1 !== 0) {
                      return content;
                    }
                    var match$9 = pagepath$1.length;
                    var match$10 = Belt_Array.get(pagepath$1, 1);
                    var exit$5 = 0;
                    if (match$9 === 1) {
                      return React.createElement(ApiOverviewLayout.Docs.make, {
                                  lang: /* Chinese */1,
  ...
  if (exit === 1) {
    var match$11 = Belt_List.fromArray(base);
    var exit$6 = 0;
    if (match$11) {
      switch (match$11.hd) {
        case "blog" :
    ...
    if (exit$6 === 2) {
      ...
      var match$12 = url.base;
      var title;
      var exit$7 = 0;
      if (match$12.length !== 1) {
        exit$7 = 3;
      } else {
