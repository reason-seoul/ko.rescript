...
鉴于各种[优势](interop-with-js-build-systems.md#popular-js-build-systems)，我们建议你检查编译后的 JavaScript 输出结果。如果你不打算检查，那么至少应当考虑将 JavaScript 输出结果也一起发布，可以通过在你的 [npmignore](https://docs.npmjs.com/cli/v7/using-npm/developers#keeping-files-out-of-your-package) 中去掉忽略项来发布。这样的话，你发布的 ReScript 包将会和 JS 文件一起被 JS 用户使用。如果你的包没有问题，JS 使用者可能甚至都不会觉察到他们安装了一个用 ReScript 写的库！
