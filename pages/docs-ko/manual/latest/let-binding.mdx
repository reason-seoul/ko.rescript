---
title: "Let 바인딩"
description: "ReScript에서 값을 바인딩하는 Let 바인딩 문법"
...
"let 바인딩"은 다른 말로 "변수 선언"이라고도 할 수 있습니다. 즉, `let`이 값과 변수 이름을 _묶는(binds)_ 것입니다. 
...
If you need _real_ mutation, e.g. passing a value around, have it modified by many pieces of code, we provides a slightly heavier [mutation feature](mutation.md).
-->
