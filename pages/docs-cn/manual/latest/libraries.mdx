...
我们建议你检查编译后的 JavaScript 输出，因为它有各种[好处](interop-with-js-build-systems.md#popular-js-build-systems)。如果你不打算检查，那么至少考虑将 JavaScript 输出结果也一起发布，可以通过在你的 [npmignore](https://docs.npmjs.com/cli/v7/using-npm/developers#keeping-files-out-of-your-package) 中去掉忽略项来发布。这样的话，你发布的 ReScript 包将会附带 JS 文件，它可以被 JS 用户使用。如果你的项目非常好，JS 使用者可能甚至不会意识到他们安装了一个用 ReScript 写的库！
